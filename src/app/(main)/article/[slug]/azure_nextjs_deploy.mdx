export const meta = {
  title: 'Deploy NextJS 13 to Azure',
  slug: 'azure_nextjs_deploy',
};
...
```makefile fileName="<root>/.deployment"
[config]
command = deploy.cmd
```
...
```makefile fileName="<root>/deploy.cmd"
