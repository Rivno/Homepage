import preview from '../../../../public/challenges/20230318.png';
      ...
      <div className={styles.content}>
        ...
        <div className={styles.main}>
          ...
          <div>
            <div>
              <h2>Order history</h2>
              <p>Manage billing information and views receipt</p>
            </div>
            <History />
            <div>
              ...
              <div className={styles.payment_method}>
                {paymentMethods.map((paymentMethod) => (
                  <div key={paymentMethod.id}>
                    <svg viewBox="0 -54.25 482.51 482.51">
                    ...
                    <div>Card ending in *{paymentMethod.id}</div>
